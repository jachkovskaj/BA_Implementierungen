...
output_dir = "Ergebnisplots_Visualization_Metriken_eigene_Daten"
...
def auswertung_modell(n: int):
    ...
    for study in sorted(os.listdir(base_dir)):
        ...
        # Funktion für generelle Visualisierung
        ...
        # Funktuion für Visualisierung mit eigenen Daten
        plan = get_plan(study)
        ...
        # Fallback: altes Verhalten, falls keine Reeval-Datei existiert
    ...
    # Subfolder anpassen je nach Visualisierung
    ...
    if plans:
        ...
        save_plot(fig, f"RMSE_TrainValTest_Modell_eigene_Daten_{n}_by_plan.png", subfolder)
    ...
    if plans:
        ...
        save_plot(fig, f"R2_TrainValTest_Modell_eigene_Daten_{n}_by_plan.png", subfolder)
    ...
    if plans:
        ...
        save_plot(fig, f"RMSE_Test_Modell_eigene_Daten_{n}_by_plan.png", subfolder)
    ...
    if plans:
        ...
        save_plot(fig, f"R2_Test_Modell_eigene_Daten_{n}_by_plan.png", subfolder)
