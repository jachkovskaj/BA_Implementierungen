...
def plots(model_nummer, submodel_nummer=None, seeds=(0, 42, 999), base_dir="Ergebnisse_Teil_1"):
    ...
    out_dir = f"Ergebnisplots_Visualization_Metriken/Plots_Vergleich_Modell_{modell_label}"
    ...
    ax.legend()
    fig.tight_layout()
    fig.savefig(os.path.join(out_dir, f"Modell_{modell_label}_Plot_1_RMSE_Train_Val_Test.png"))
    plt.close(fig)
    ...
    ax.legend()
    fig.tight_layout()
    fig.savefig(os.path.join(out_dir, f"Modell_{modell_label}_Plot_2_R2_Train_Val_Test.png"))
    plt.close(fig)
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(out_dir, f"Modell_{modell_label}_Plot_3_RMSE_R2_Train_Val_Test.png"))
    plt.close(fig)
    ...
    ax.grid(axis="y", linestyle="--", alpha=0.7)
    fig.tight_layout()
    fig.savefig(os.path.join(out_dir, f"Modell_{modell_label}_Plot_4_RMSE_nur_Test.png"))
    plt.close(fig)
    ...
    ax.grid(axis="y", linestyle="--", alpha=0.7)
    fig.tight_layout()
    fig.savefig(os.path.join(out_dir, f"Modell_{modell_label}_Plot_5_R2_nur_Test.png"))
    plt.close(fig)
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(out_dir, f"Modell_{modell_label}_Plot_6_RMSE_R2_Test.png"))
    plt.close(fig)
