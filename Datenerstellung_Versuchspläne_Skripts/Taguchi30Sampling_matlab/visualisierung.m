function [] = visualisierung(Charge, Knoten, Elemente, Elementenanzahl,u,v, numVector, Nummer)
...
plot([u(1)+v(1,numVector);u(1)+v(1,1)],[u(2)+v(2,numVector);u(2)+v(2,1)],'k.-','LineWidth',2)
 %% Plot Skalierung
 %axis([-250 450 -325 250])
 path=append('Trainingsdaten10^2/Bilder_mitVektoren/', int2str(Nummer),'.png');
 exportgraphics(fg,path);