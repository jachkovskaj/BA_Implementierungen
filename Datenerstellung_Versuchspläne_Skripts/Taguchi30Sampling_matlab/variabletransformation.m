function [output_neu,output_alt] = variabletransformation(positionx, positiony, designvariablen, Elemente, Elementenanzahl, Knoten,Loeschliste, Nummer)
...
v=zeros(2,numVector);
for i=1:numVector
    v1 = cos((i-1)*2*pi/numVector)*designvariablen(1,i);
    v2 = sin((i-1)*2*pi/numVector)*designvariablen(1,i);
    v(:,i)= [v1 ; v2];
end
