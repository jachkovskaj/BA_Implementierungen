function [] = visualisierungCharge(Charge, Knoten, Elemente, Elementenanzahl,Nummer)
...
% % axis([0 200 -75 0])
 ...
 path=append('Trainingsdaten10^2/Bilder_Einleger/', int2str(Nummer),'.png');
